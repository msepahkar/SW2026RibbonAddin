; SW2025RibbonAddin.iss — uses a local "payload" folder next to this script

#define AppName       "SW2025RibbonAddin"
#define AppVersion    "1.0.0"
#define AppPublisher  "Mehdi"
#define AddinGuid     "{B67E2D5A-8C73-4A3E-93B6-1761C1A8C0C5}"   ; must match Addin.cs
#define AddinDll      "SW2025RibbonAddin.dll"
...
DefaultDirName={pf64}\Mehdi\SW2025RibbonAddin
OutputBaseFilename=SW2025RibbonAddin-Setup
Compression=lzma
...
; If you later need extra runtime DLLs, copy them into 'payload'
; and add explicit lines like the two examples below:
; Source: "{#PayloadDir}\Newtonsoft.Json.dll"; DestDir: "{app}"; Flags: ignoreversion
; Source: "{#PayloadDir}\YourHelper.dll";      DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{cmd}"; \
  ...
  StatusMsg: "Registering SolidWorks add-in..."; Flags: runhidden waituntilterminated
